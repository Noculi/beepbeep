...
function checkForUpdate () {
  var options = {
    url: 'https://raw.githubusercontent.com/Noculi/beepbeep/master/package.json',
    method: 'GET',
    headers: {
  ...
  request(options, function (err, res, body) {
    ...
    if (packageJSON.version === json.version) {
      ...
      webLogger('BEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEP!')
...
app.get('/apiV1/shutdown', function (req, res) {
  webLogger('Shutting down BeepBeep.')
...
app.get('/apiV1/configChange', function (req, res) {
  webLogger('Changing BeepBeep config.')
})
